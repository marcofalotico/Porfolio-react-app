  ...
  return (
    <div className="home__data">
        ...
        <h3 className="home__subtitle">
            Frontend Developer &<br />Social Media Content Creator
        </h3>
        <p className="home__description">
            Hi! I'm a web developer and content creator with a strong passion for travel and outdoor sports like surfing and snowboarding.
        </p>
