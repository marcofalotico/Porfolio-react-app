...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_uqodref', 'template_2s86t4r', form.current, 'WV-4bScvZFqM0CIIM')
        e.target.reset();
    };
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">falotico93@gmail.com</span>
                        
                        <a href="mailto:falotico93@gmail.com" className="contact__button">
                            Write Me{" "} 
